...
class PhaseDecoderParser(BaseOptionParser):
    def __init__(self):
        ...
        self.parser.add_argument('--always_remove', type=int, default=0)
        self.parser.add_argument('--lambda_rec', type=float, default=1.)
        self.parser.add_argument('--load', type=str, default="Dataset")
        self.parser.add_argument('--save', type=str, default="./results/test")
        ...
        self.parser.add_argument('--use_gen2_dataset', type=int, default=0)
...
class MotionMatchingOption(BaseOptionParser):
    def __init__(self):
        super().__init__()
        self.parser.add_argument('--num_frames_per_window', type=int, default=None)
        self.parser.add_argument('--path4manifold', type=str, default='')
        self.parser.add_argument('--needed_channel_names', type=str, default='')
        self.parser.add_argument('--normalize', type=int, default=1)
        self.parser.add_argument('--std_cap', type=float, default=1e-3)
        self.parser.add_argument('--weight_pose', type=float, default=1.)
        self.parser.add_argument('--preset_name', type=str, default='human2dog')
        self.parser.add_argument('--phase_name', type=str, default='default')
        self.parser.add_argument('--use_dtw', type=int, default=1)
        self.parser.add_argument('--target_id', type=int, default=0)
        self.parser.add_argument('--use_frequency_align', type=int, default=0)
        self.parser.add_argument('--export_npz_version', type=int, default=1)
        self.parser.add_argument('--align_with_avg_freq', type=int, default=0)
        self.parser.add_argument('--desired_frequency', type=float, default=1.)
